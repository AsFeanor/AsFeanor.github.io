      ...
      <form id="myForm" @submit.prevent="next" @keydown.enter.prevent="next">
        ...
        <div class="row justify-content-end mt-5 pt-5">
          <div class="col-2 mb-5 mt-5 pt-5 pl-0">
            <div class="row">
              {{ activeStep.stepId }} of {{ formLength }} answered
            </div>
            <div class="row">
...
export default {
  ...
  methods: {
    // Getting Addresses
    getAddresses() {
      axios.get(`https://api.test-aws.lifesycle.co.uk/api/v2/fps?postcode=${this.forms[this.activeStep.form.unique_id]}`)
          .then((response) => {
            this.addresses = response.data.addresses
            this.address = true
            console.log(response.data.addresses);
            console.log(this.addresses)
            console.log(this.forms[this.activeStep.form.unique_id]);
          })
          .catch((e) => {
            console.log(e)
          })
